...
public class GeneralMember extends AppCompatActivity
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.startsWith("tel:")) {
                    ...
                    if (isNetworkStatusAvialable(getApplicationContext())) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(GeneralMember.this);
    ...
    private void hideitem() {
        ...
        drawer_menu.findItem(R.id.GeneralMember).setChecked(true).setEnabled(false);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.notify:
                Intent n = new Intent(GeneralMember.this, Notification.class);
                startActivity(n);
                return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.Notification:
                ...
                break;
            case R.id.nav_home:
                Intent h = new Intent(GeneralMember.this, Home.class);
                startActivity(h);
                break;
            case R.id.alumni:
                String AText = getString(R.string.commingsoon);
                AlertDialog.Builder Abuilder = new AlertDialog.Builder(GeneralMember.this);
            ...
            case R.id.adviser:
                ...
                AlertDialog.Builder Vbuilder = new AlertDialog.Builder(GeneralMember.this);
            ...
            case R.id.ExecutiveMember:
                Intent i = new Intent(GeneralMember.this, ExecutiveMember.class);
                startActivity(i);
                break;
            case R.id.GeneralMember:
                Intent s = new Intent(GeneralMember.this, GeneralMember.class);
                startActivity(s);
                break;

            case R.id.nav_update:
                if (isNetworkStatusAvialable(getApplicationContext())) {
                    UpdateChecker.checkForDialog(GeneralMember.this);
                } else {
            ...
            case R.id.nav_share:
                ...
                break;
            case R.id.nav_about:
                Intent a = new Intent(GeneralMember.this, About.class);
                startActivity(a);
                break;
