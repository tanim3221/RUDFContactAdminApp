...
public class ExecutiveMember extends AppCompatActivity
    ...
    private String currentUrl = "http://rudf.6te.net/webapp/database/view/executive.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadWeb("http://rudf.6te.net/webapp/database/view/executive.php");
    ...
    public void LoadWeb(String url) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                String defaulturl = "http://rudf.6te.net/webapp/database/view/executive.php";
                currentUrl = url;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.notify:
                Intent n = new Intent(ExecutiveMember.this, Notification.class);
                startActivity(n);
                return true;
            case R.id.nav_about_app:
                Intent h = new Intent(ExecutiveMember.this, AboutApp.class);
                startActivity(h);
                return true;
            case R.id.pro:
                Intent p = new Intent(ExecutiveMember.this, ProfileActivity.class);
                startActivity(p);
                return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.alumni:
                ...
                AlertDialog.Builder Abuilder = new AlertDialog.Builder(ExecutiveMember.this);
            ...
            case R.id.adviser:
                ...
                AlertDialog.Builder Vbuilder = new AlertDialog.Builder(ExecutiveMember.this);
